...
SECRET_KEY = "django-insecure-^1i=ngp!o#wi_+^w)kc4iz)o8z+d=ov4ow^2*gevli)^s)*u&d"
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API for admin to manage the library',
    'VERSION': '1.0.0',
...
CELERY_TASK_ROUTES = {
    "backend_app.tasks": {"queue": "backend_queue"},
}
